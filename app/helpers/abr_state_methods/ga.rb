module AbrStateMethods::GA
  ...
  def form_field_items
    [
      ...
      {"abr_id_type1": {type: :checkbox}},
      {"abr_drivers_license": {required: :if_visible, visible: "abr_id_type1", regexp: /\A\d{9}\z/}},	
      {"abr_id_type2": {type: :checkbox}},	
      {"abr_id_instructions": {type: :instructions, visible: "abr_id_type2"}},
