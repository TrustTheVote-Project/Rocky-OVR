...
class Partner < ActiveRecord::Base
  ...
  scope :government, -> { where("is_government_partner == 't' OR is_government_partner == true") }
  scope :standard, -> { where("is_government_partner != 't' AND is_government_partner != true") }
