class StateRegistrants::Base < ActiveRecord::Base
  ...
  #delegate :ab_tests,:full_name,:finish_with_state_eligible?, to: :registrant
  
  delegate :finish_with_state_eligible?,:prev_name_title,:prev_first_name,:prev_middle_name,:prev_last_name,:prev_name_suffix,:prev_address,:prev_unit,:home_address, to: :registrant
