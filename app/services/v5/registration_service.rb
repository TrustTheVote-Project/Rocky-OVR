...
module V5
  class RegistrationService
    ...
    #   partner = V5::PartnerService.find_partner(partner_id, partner_api_key)
    ...
    def self.create_report(query)
      ...
      if partner_id
        g_partner = true
        partner = V5::PartnerService.find_partner(query[:gpartner_id], query[:gpartner_api_key])
        #regs = Registrant
        ...
        partner = V5::PartnerService.find_partner(query[:partner_id], query[:partner_api_key])
      end
      ...
      return {
        ...
        status_url: g_partner ? Rails.application.routes.url_helpers.api_v5_gregistrant_report_url(r, host: RockyConf.api_host_name) : Rails.application.routes.url_helpers.api_v5_registrant_report_url(r, host: RockyConf.api_host_name),
    ...
    def self.get_report(query)
      ...
      raise(ArgumentError.new(V5::RegistrationService::REPORT_PERMISSIONS_ERROR)) if r.partner != partner
      ...
      return {
        ...
        current_index: r.current_index,
        status_url: g_partner ? Rails.application.routes.url_helpers.api_v5_gregistrant_report_url(r, host: RockyConf.api_host_name) : Rails.application.routes.url_helpers.api_v5_registrant_report_url(r, host: RockyConf.api_host_name),
        download_url: r.status == Report::Status.complete.to_s ? (g_partner ? Rails.application.routes.url_helpers.api_v5_download_gregistrant_report_url(r, host: RockyConf.api_host_name) : Rails.application.routes.url_helpers.download_api_v5_registrant_report_url(r, host: RockyConf.api_host_name)) : nil
      }
    end
