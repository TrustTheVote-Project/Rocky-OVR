...
module Rocky
  class Application < Rails::Application
    ...
    config.assets.precompile += %w( admin.css partner.css jquery.qtip.min.css qtip-custom.css registration.css registration2.css reset.css rocky.css nvra.css state_configuration.css states/pa.css)
