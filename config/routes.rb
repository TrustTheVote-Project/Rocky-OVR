Rocky::Application.routes.draw do
  ...
  match "/am-i-registered", to: "catalist_lookups#new", via: :get
  ...
  resources "am-i-registered", :only => [:new, :create, :show, :update], :controller=>"catalist_lookups", as: :catalist_lookups do
    member do
      get "registration"
      get "abr"
    end
