Feature: Admin UI
  ...
  I want to manage partner data
    ...
    Scenario: Editing email for partner != 1
      ...
      And I should see an email body field for "State OVR Responder" for each language
      ...
      And I should see an email subject field for "State OVR Responder" for each langauge
