...
class StateImporter
  ...
  def self.state_localizations
    %w(not_participating_tooltip race_tooltip party_tooltip no_party id_number_tooltip sub_18 registration_deadline pdf_instructions pdf_other_instructions email_instructions)
  end
